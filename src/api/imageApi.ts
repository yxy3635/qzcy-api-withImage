...
export const imageApi = {
  generate(prompt: string, qualityCode: string, size?: string, referenceImages: string[] = []) {
    return http.post<ApiResponse<ImageRecord>>('/image/generate', { prompt, qualityCode, size, referenceImages })
  },
  detail(id: number) {
